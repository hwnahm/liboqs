#ifndef PQCLEAN_SPHINCSHARAKA256FSIMPLE_AESNI_API_H
#define PQCLEAN_SPHINCSHARAKA256FSIMPLE_AESNI_API_H
...
#define PQCLEAN_SPHINCSHARAKA256FSIMPLE_AESNI_CRYPTO_ALGNAME "SPHINCS+"
