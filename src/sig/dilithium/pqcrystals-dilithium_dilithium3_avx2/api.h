...
int pqcrystals_dilithium2_avx2_keypair(uint8_t *pk, uint8_t *sk, uint8_t *seed);
...
int pqcrystals_dilithium3_avx2_keypair(uint8_t *pk, uint8_t *sk, uint8_t *seed);
...
int pqcrystals_dilithium3aes_avx2_keypair(uint8_t *pk, uint8_t *sk, uint8_t *seed);
...
int pqcrystals_dilithium5_avx2_keypair(uint8_t *pk, uint8_t *sk, uint8_t *seed);
...
int pqcrystals_dilithium5aes_avx2_keypair(uint8_t *pk, uint8_t *sk, uint8_t *seed);
